...
namespace SimpleMan.VisualRaycast
{
    ...
    {
        private const string SPHERE_MESH_RESOURCES_PATH = "PrimitiveSphere";
        private const string HALFSPHERE_MESH_RESOURCES_PATH = "PrimitiveHalfsphere";
        private const string BOX_MESH_RESOURCES_PATH = "PrimitiveCube";
        private const string CYLINDER_MESH_RESOURCES_PATH = "PrimitiveCylinder";
